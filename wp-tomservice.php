...
Copyright (C) 2013-2022 Mark Washeim <blueprint@poetaster.de>
 ...
 * Author URI: http://github.com/poetaster/tomservice
 * License: GPL v2.0 http://www.gnu.org/licenses/gpl-2.0
 * Vgwort services at
 * pixel service https://tom.vgwort.de/services/1.0/pixelService.wsdl
 * message service https://tom.vgwort.de/services/2.0/messageService.wsdl
 */
...
//define('MESSAGE_SERVICE_WSDL', 'https://tom.vgwort.de/services/2.0/messageService.wsdl');
define('PIXEL_SERVICE_WSDL', 'https://tom-test.vgwort.de/services/1.0/pixelService.wsdl');
define('MESSAGE_SERVICE_WSDL', 'https://tom-test.vgwort.de/services/2.0/messageService.wsdl');
...
function wpTomServiceRegisterSettingsPage()
{
  ...
  add_submenu_page('options-general.php', 'VG TOM Request', 'VG TOM Request', 'publish_posts', 'wpTomServiceRequest', 'wpTomServiceRequestPage');
}
